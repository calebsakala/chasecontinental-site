          ...
          <div className="flex flex-col gap-24">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative group hover-border-snake rounded-2xl">
                ...
                <div className="rounded-2xl border border-white/20 overflow-hidden shadow-2xl hover:shadow-violet-500/20 transition-all duration-500 backdrop-blur-sm bg-black/10 bg-gradient-to-br from-[#1e3a5f]/5 to-transparent">
                  <img
