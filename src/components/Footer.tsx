        ...
        <div className="grid gap-10 md:grid-cols-4">
          <div className="md:col-span-2">
            ...
            <p className="mt-4 text-sm text-muted-foreground max-w-sm leading-relaxed">
              We build software that changes the way people work.
            </p>
          </div>

          <div>
            <h4 className="mb-4 text-sm font-bold font-heading text-foreground uppercase tracking-wider">
              Company
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  href="https://www.linkedin.com/company/chase-continental"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2.5 text-sm text-muted-foreground hover:text-teal transition-colors"
                >
        ...
        <div className="mt-12 border-t border-border/50 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-muted-foreground/60 hover:text-teal transition-colors"
              aria-label="LinkedIn"
            >
