      ...
      <main className="pt-16">
        <div className="mx-auto max-w-3xl px-6 py-16">
          ...
          <div className="space-y-8">
            ...
            <section>
              <h2 className="text-xl mb-3 text-foreground">Information We Collect</h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-xl mb-3 text-foreground">How We Use Your Information</h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-xl mb-3 text-foreground">Third-Party Services</h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
                We use the following third-party services to operate our business:
              </p>
              <div className="rounded-xl border bg-secondary/30 p-5">
                <h4 className="text-sm font-semibold text-foreground mb-2">Google Calendar</h4>
                <p className="text-sm text-muted-foreground">
                  Our booking system uses Google Calendar. When you book a demo, your information is processed by Google according to their privacy policy. We recommend reviewing{" "}
            ...
            <section>
              <h2 className="text-xl mb-3 text-foreground">Your Privacy Rights</h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              <ul className="list-disc pl-5 space-y-2 text-sm text-muted-foreground">
                ...
                <li><strong className="text-foreground">Objection:</strong> Object to our processing of your personal information</li>
              ...
              <p className="mt-4 text-sm text-muted-foreground">
                ...
                <a href="mailto:charles@chasecontinental.com" className="text-gold hover:underline">
            ...
            <section>
              <h2 className="text-xl mb-3 text-foreground">International Data Transfers</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="text-xl mb-3 text-foreground">Children's Privacy</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="text-xl mb-3 text-foreground">Changes to This Privacy Policy</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              ...
              <div className="mt-4 rounded-xl border bg-secondary/30 p-5 space-y-2 text-sm text-muted-foreground">
                <p><strong className="text-foreground">Chase Continental</strong></p>
                <p>Email:{" "}
                  <a href="mailto:charles@chasecontinental.com" className="text-gold hover:underline">
                    charles@chasecontinental.com
                  </a>
                ...
                <p>Website:{" "}
                  <a href="https://chasecontinental.com" className="text-gold hover:underline">
