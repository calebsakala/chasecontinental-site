...
const guideSectionCards = [
  {
    ...
    stat: "Cut time spent on repetitive, high-volume work",
    icon: Target,
    color: "hsl(190, 95%, 45%)",
  },
  {
    ...
    stat: "Surface the hidden steps that break automation",
    icon: GitBranch,
  ...
  },
  {
    ...
    stat: "Handle the edge cases before they cause failures",
    icon: CheckCircle2,
    color: "hsl(160, 84%, 39%)",
  },
  {
    ...
    stat: "Set conservative, defensible success metrics",
    icon: BarChart3,
    color: "hsl(45, 80%, 55%)",
  },
  {
    ...
    stat: "Roll out in phases with clear ownership",
    icon: Rocket,
    color: "hsl(270, 60%, 55%)",
  },
];
...
const faqItems = [
  ...
  },
  {
    ...
    a: "Automation benefits apply across all sectors. The framework focuses on the fundamentals: picking the right workflow, mapping it honestly, and designing for exceptions, which hold true whatever your industry.",
  },
  {
    q: "Can I get help?",
