...
const resources = [
  {
    ...
    badge: "Case Study",
    description: "A three-week research cycle compressed to under an hour, a 10.4× productivity gain running for under $5/month. See the full breakdown.",
    icon: FileBarChart,
  ...
  },
  {
    ...
    description: "Pick sector + size to get illustrative savings, ROI, and payback ranges in seconds. Grounded estimates, not a guarantee.",
    icon: Calculator,
