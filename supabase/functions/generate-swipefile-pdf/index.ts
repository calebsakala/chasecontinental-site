...
const PATTERNS = [
  {
    ...
    category: "E-commerce",
    overview: "Streamlines end-to-end order processing from receipt to delivery, automating stock checks, payment confirmation, warehouse notification, label generation, and tracking updates.",
    realInsights: "Platforms like NetworkON automate this to handle peak volumes, reducing manual emails and boosting fulfillment speed by 30%. Companies with mature fulfillment automation report 40% fewer shipping errors and 25% faster order-to-door times.",
    whereItBreaks: "Fails during inventory discrepancies (e.g., real-time stockouts) or integration lags between ERP/CRM systems, leading to over-promising deliveries. Multi-warehouse routing adds complexity when stock levels aren't synchronized in real-time. Payment gateway timeouts can stall the entire chain.",
    implementationTips: [
  ...
  },
  {
    ...
    overview: "Uses AI to forecast demand and auto-trigger replenishment orders based on historical data, sales trends, and external factors like weather and economic indicators.",
    realInsights: "Striim's real-time analytics prevent stockouts in supply chains, with ML models analyzing routes and bundling dead stock for clearance, improving profitability by 15-20%. Companies using predictive replenishment see 30% reduction in carrying costs.",
    whereItBreaks: "Inaccurate data inputs (e.g., unaccounted seasonal spikes) cause overstocking. Lacks human oversight for black-swan events like supply disruptions. New product launches have no historical data to train on. Supplier lead time variability undermines auto-ordering accuracy.",
    implementationTips: [
  ...
  },
  {
    ...
    category: "Logistics",
    overview: "Dynamically plans routes using AI to factor in traffic, weather, load, and deadlines, minimizing fuel consumption and delivery time across the fleet.",
    realInsights: "Datamatics' Agentic AI agents optimize LTL consignments, reducing delivery times by 25% in logistics networks. JD.com's real-time routing handles 1M+ daily deliveries with 99.2% on-time rates.",
    whereItBreaks: "Relies on accurate geo-data; breaks in rural areas with poor connectivity or unexpected road closures. Real-time recalculation under high load can cause timeout cascades. Driver override behavior (ignoring suggested routes) creates data integrity issues.",
    implementationTips: [
  ...
  },
  {
    ...
    category: "Logistics",
    overview: "Deploys robots and automated systems for picking, sorting, and packing, guided by ML for efficient travel paths within warehouse zones.",
    realInsights: "AI-powered warehouses reduce sorting time by 40%, as seen in e-commerce giants with AS/RS cutting human travel. Amazon's Kiva robots handle 300+ picks/hour vs 100 for manual processes.",
    whereItBreaks: "Hardware failures or mismatched item sizes disrupt flow. High initial costs ($2-5M+) limit scalability for SMEs. Software bugs in path planning can cause robot gridlock. Mixed-SKU pallets confuse picking algorithms.",
    implementationTips: [
  ...
  },
  {
    ...
    category: "BPO",
    overview: "Automates data entry, validation, and reconciliation of invoices using software bots across multiple formats, currencies, and regulatory requirements.",
    realInsights: "BPO firms cut processing time by 40% via RPA, handling global logistics workflows across 15 countries. Staple.ai reports 92% straight-through processing rates for standardized invoice formats.",
    whereItBreaks: "Non-standard invoice formats cause OCR errors (handwritten notes, unusual layouts). Security risks if bots access sensitive financial data without encryption. Currency conversion edge cases create reconciliation mismatches. PDF image quality directly impacts accuracy.",
    implementationTips: [
  ...
  },
  {
    ...
    category: "Supply Chain",
    overview: "Provides end-to-end tracking via IoT sensors and analytics platforms, alerting stakeholders on delays, temperature deviations, or anomalies in real-time.",
    realInsights: "Flow.space uses big data for accurate inventory positioning, enabling proactive adjustments in e-commerce supply chains. Companies with real-time visibility report 20% faster response to disruptions.",
    whereItBreaks: "Data silos between partners fragment visibility — each tier may use different standards. IoT feed latency during peak loads degrades real-time accuracy. Sensor battery failures create blind spots. Legacy partner systems resist API integration.",
    implementationTips: [
  ...
  },
  {
    ...
    category: "Big Data",
    overview: "Analyzes massive datasets to predict sales volumes, incorporating promotions, market trends, competitor pricing, and macroeconomic indicators.",
    realInsights: "JD.com's AI models improve forecasting accuracy by 20% using explainable AI for promotion planning. Best-in-class forecasters achieve MAPE (Mean Absolute Percentage Error) under 15%.",
    whereItBreaks: "Biased historical data leads to flawed predictions — garbage in, garbage out. Models can't account for truly novel events (pandemics, trade wars). Promotional cannibalization effects confuse simple models. Real-time data pipeline failures cause stale predictions.",
    implementationTips: [
  ...
  },
  {
    ...
    category: "Operations",
    overview: "Detects and resolves workflow issues like delays, quality failures, and data anomalies via intelligent alerts, auto-rerouting, and escalation protocols.",
    realInsights: "NetSuite's supply chain automation handles exceptions in manufacturing, reducing downtime by 30%. Mature exception management systems resolve 70% of incidents without human intervention.",
    whereItBreaks: "Over-reliance on static rules misses nuanced, multi-factor cases. Escalation loops can overwhelm teams when thresholds are miscalibrated. Alert fatigue causes operators to ignore genuine critical issues. New exception types aren't caught by existing rules.",
    implementationTips: [
  ...
  },
  {
    ...
    category: "E-commerce",
    overview: "Automates return requests, quality inspections, refund processing, restocking decisions, and customer communication in a single orchestrated flow.",
    realInsights: "RPA cuts e-commerce returns processing time by 50%, with AI-powered fraud detection reducing fraudulent returns by 35%. Companies with automated returns report 20% higher customer satisfaction scores.",
    whereItBreaks: "High return volumes during sales events overwhelm queue capacity. Poor integration with inventory systems causes double-counting or ghost stock. Subjective quality assessments resist full automation. Cross-border returns add customs and currency complexity.",
    implementationTips: [
  ...
  },
  {
    ...
    category: "Supply Chain",
    overview: "Suppliers auto-monitor retail stock levels and replenish based on shared real-time data, shifting inventory management responsibility to the vendor.",
    realInsights: "Lean supply chain systems optimize manufacturing supply chains, reducing holding costs by 25%. Walmart's VMI program with P&G is the gold standard, eliminating 15% of distribution costs.",
    whereItBreaks: "Trust issues in data sharing — retailers fear exposing sales data; suppliers fear demand manipulation. Delays if supplier ERP systems are incompatible with retailer platforms. Demand spikes require faster response than VMI agreements typically allow.",
    implementationTips: [
  ...
  },
  {
    ...
    category: "E-commerce",
    overview: "Adjusts prices in real-time based on demand signals, competitive pricing, inventory levels, time of day, and customer segments.",
    realInsights: "Datamatics' AI agents for logistics generate competitive LTL pricing, boosting margins by 8-12%. Airlines and hotels pioneered this — e-commerce adoption is growing 30% year-over-year.",
    whereItBreaks: "Rapid fluctuations alienate customers who see different prices minutes apart. Regulatory hurdles in some markets (EU price discrimination rules). Competitor scraping introduces noisy signals. Price wars can emerge from two dynamic engines competing.",
    implementationTips: [
  ...
  },
  {
    ...
    category: "Supply Chain",
    overview: "Identifies slow-moving inventory using velocity analysis and auto-triggers markdown sequences, channel-specific bundling, or liquidation auction workflows.",
    realInsights: "Striim's analytics bundle dead stock for e-commerce discounts, clearing inventory efficiently. Companies with automated liquidation recover 40% more value vs ad-hoc markdown approaches.",
    whereItBreaks: "Misidentification of seasonal items (winter coats flagged in summer). Over-discounting erodes brand perception and trains customers to wait for sales. Bundling slow-movers with popular items can hurt star product margins.",
    implementationTips: [
  ...
  },
  {
    ...
    category: "BPO",
    overview: "Routes customer queries to AI chatbots or specialist teams using intent classification, automating responses for common issues while escalating complex cases.",
    realInsights: "Staple.ai's CRM handles 1M queries monthly, boosting satisfaction by 20%. Best-in-class systems resolve 65% of tickets without human intervention and reduce average handling time by 40%.",
    whereItBreaks: "Complex multi-issue queries confuse single-intent classifiers. AI hallucinations in unstructured free-text responses erode trust. Sentiment detection fails on sarcasm and cultural nuances. Escalated tickets lose context in the handoff to human agents.",
    implementationTips: [
  ...
  },
  {
    ...
    category: "Operations",
    overview: "Automates regulatory compliance checks against current rules, generates audit reports, flags violations, and routes remediation tasks to responsible teams.",
    realInsights: "DHL's AI analytics ensure resilient supply chains with prescriptive compliance optimization. Automated compliance reduces audit preparation time by 60% and catches 3× more violations than manual processes.",
    whereItBreaks: "Evolving laws outpace rule engine updates — especially across jurisdictions. Incomplete data inputs lead to false positives that waste investigator time. Natural language regulations resist rule-based encoding. Cross-border compliance multiplies complexity exponentially.",
    implementationTips: [
  ...
  },
  {
    ...
    category: "Supply Chain",
    overview: "Agentic AI coordinates planning, sourcing, manufacturing, logistics, and delivery optimization across all stages using autonomous decision-making agents.",
    realInsights: "ArXiv research frameworks use generative AI for e-commerce, bridging intent to action. Early adopters report 25% improvement in supply chain responsiveness and 15% reduction in total logistics cost.",
    whereItBreaks: "Over-complexity in multi-agent systems creates debugging nightmares. Dependency on high-quality, real-time data across all stages. Agent conflicts when optimizing for competing objectives (cost vs speed). Lack of explainability makes stakeholders distrustful of autonomous decisions.",
    implementationTips: [
...
function buildPdf(req: SwipeFileRequest): Uint8Array {
  ...
  doc.setFontSize(36);
  doc.setFont("helvetica", "bold");
  const titleLines = doc.splitTextToSize("15 Proven Automation Workflow Patterns", CW);
  ...
  const subLines = doc.splitTextToSize("Real-World Strategies for Logistics, Supply Chain, Big Data, BPO, and E-Commerce", CW);
  ...
  for (const pattern of PATTERNS) {
    ...
    doc.setTextColor(...DARK);
    doc.setFontSize(8);
    doc.text(pattern.category.toUpperCase(), M + 52.5, y + 6.5, { align: "center" });
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const pdfBytes = buildPdf({ lead_id, name, email, company });
